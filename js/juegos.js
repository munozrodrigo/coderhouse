...
function operacion() {
	var num1 = prompt(
		nombre +
			'. Necesitamos que ingrese 4 números para realizar operaciones sobre él.\nIngrese el número 1'
	);
...
function estatura() {
	alert(
		nombre +
			'. Deberá ingresar su altura con un decimal y con punto. Ejemplo: 1.7'
	);
...
function solicitud() {
	var precio = Number(prompt(nombre + '. ¿Cuál es el precio?'));
	var iva = precio * 0.21;
